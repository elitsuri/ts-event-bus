"""
TS Event Bus - Backend API
TypeScript event bus and pub/sub system for microservices
"""
...
app = FastAPI(
    title="TS Event Bus",
    description="TypeScript event bus and pub/sub system for microservices",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "TS Event Bus"}
